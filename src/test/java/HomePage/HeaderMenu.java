...
public class HeaderMenu {
    ...
    public HeaderMenu(String name, String surname, String address, String metroStation, String phoneNumber, String dateOrder, String rentalPeriod, String colorScooter, String comment, String expected) {
        this.name = name;
    ...
    class creatingOrderFromHeader {
        ...
        public creatingOrderFromHeader(WebDriver driver, String name, String surname, String address, String metroStation, String phoneNumber, String dateOrder, String rentalPeriod, String colorScooter, String comment) {
            this.driver = driver;
    ...
    @Test
    public void creationOrderFromHeader() {
        creatingOrderFromHeader objCreatingOrderFromHeader = new creatingOrderFromHeader(driver, name, surname, address, metroStation, phoneNumber, dateOrder, rentalPeriod, colorScooter, comment);

        objCreatingOrderFromHeader.fillingFormFirstStep(name, surname, address, metroStation, phoneNumber);
        objCreatingOrderFromHeader.movingToNextStep();

        objCreatingOrderFromHeader.fillingFormSecondStep(dateOrder, rentalPeriod, colorScooter, comment);
        objCreatingOrderFromHeader.clickCreateOrderButton();

        objCreatingOrderFromHeader.agreeWindow();

        Boolean result = objCreatingOrderFromHeader.windowFormedOrder();
